  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        "Upcoming: A seven-day lookahead of what's scheduled next.",
      ],
    },
    {
      id: 'habits',
...
const portugueseBrazil: HelpContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        ...
        'Próximas: Visão dos próximos sete dias agendados.',
      ],
    },
    {
      id: 'habits',
  ...
  shortcuts: [
    ...
    { keys: ['G', 'T'], label: 'Ir para o Diário' },
    { keys: ['G', 'U'], label: 'Ir para Próximas' },
