...
- [x] Modify `app/src/api/client.ts`
...
- [x] Modify `api/src/services/taskService.ts`
...
- [x] Modify `app/src/components/TaskItem.tsx`
...
- [x] Implement Order Calculation Logic (Midpoint)
...
- [x] Implement `handleAddAbove` & update `handleAddBelow`
...
- [x] Implement Project Assignment Logic
...
- [x] Implement Context Menu Rendering
